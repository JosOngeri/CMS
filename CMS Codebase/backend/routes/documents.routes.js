...
// Upload documents
router.post('/upload', uploadLimiter, upload.array('files', 10), DocumentsController.uploadDocuments.bind(DocumentsController));
...
// Document approval
router.post('/document-approval/:id/approve', requireRole(['Super Admin', 'Pastor']), DocumentsController.approveDocument.bind(DocumentsController));
router.post('/document-approval/:id/reject', requireRole(['Super Admin', 'Pastor']), DocumentsController.rejectDocument.bind(DocumentsController));

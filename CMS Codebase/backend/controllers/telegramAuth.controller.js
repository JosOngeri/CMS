...
class TelegramAuthController extends BaseController {
  ...
  async getAuthMethods(req, res) {
    try {
      ...
      this.success(res, { methods: sanitizedMethods });
    } catch (error) {
      this.logger.error('getAuthMethods', error);
      this.error(res, 'Failed to fetch authentication methods');
    }
  }
  ...
  async createAuthMethod(req, res) {
    try {
      ...
      this.error(res, 'Failed to create authentication method');
    }
  }
  ...
  async updateAuthMethod(req, res) {
    try {
      ...
      this.error(res, 'Failed to update authentication method');
    }
  }
  ...
  async deleteAuthMethod(req, res) {
    try {
      ...
      this.error(res, 'Failed to delete authentication method');
    }
  }
  ...
  async setDefault(req, res) {
    try {
      ...
      this.error(res, 'Failed to set default method');
    }
  }
  ...
  async testConnection(req, res) {
    try {
      ...
      this.error(res, 'Failed to test connection');
    }
  }
  ...
  async startVerification(req, res) {
    try {
      ...
      this.error(res, 'Failed to start verification');
    }
  }
  ...
  async verifyCode(req, res) {
    try {
      ...
      this.error(res, 'Failed to verify code');
    }
  }
}

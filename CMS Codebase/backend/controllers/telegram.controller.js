...
class TelegramController extends BaseController {
  ...
  async getChannels(req, res) {
    try {
      ...
      this.success(res, { data: channels });
    } catch (error) {
      this.logger.error('getChannels', error);
      this.error(res, 'Failed to fetch channels');
    }
  }
  ...
  async createChannel(req, res) {
    try {
      ...
      if (!isValid) {
        return this.badRequest(res, 'Invalid channel ID or cannot access channel');
      }
      ...
      this.error(res, 'Failed to create channel');
    }
  }
  ...
  async updateChannel(req, res) {
    try {
      ...
      this.success(res, { message: 'Channel updated successfully', data: channel });
    } catch (error) {
      this.logger.error('updateChannel', error);
      this.error(res, 'Failed to update channel');
    }
  }
  ...
  async deleteChannel(req, res) {
    try {
      ...
      this.error(res, 'Failed to delete channel');
    }
  }
  ...
  async postToChannel(req, res) {
    try {
      ...
      this.success(res, { message: 'Message posted successfully', data: result });
    } catch (error) {
      this.logger.error('postToChannel', error);
      this.error(res, 'Failed to post message');
    }
  }
  ...
  async getPosts(req, res) {
    try {
      ...
      this.success(res, { data: posts });
    } catch (error) {
      this.logger.error('getPosts', error);
      this.error(res, 'Failed to fetch posts');
    }
  }
  ...
  async getSettings(req, res) {
    try {
      ...
      if (!settings) {
        return this.notFound(res, 'Settings not found');
      }
      ...
      this.success(res, { data: safeSettings });
    } catch (error) {
  ...
  async updateSettings(req, res) {
    try {
      ...
      this.success(res, { message: 'Settings updated successfully' });
    } catch (error) {
  ...
  async handleWebhook(req, res) {
    try {
      ...
      this.error(res, 'Failed to process webhook');
    }
  }
    ...
    try {
      ...
      this.success(res, {
        data: {
          ...
          authenticated: isUserApiConfigured
        }
      });
    } catch (error) {
      this.logger.error('getAuthStatus', error);
      this.error(res, 'Failed to get auth status');
    }
  }
  ...
  async startAuth(req, res) {
    try {
      ...
      this.error(res, 'Failed to start authentication');
    }
  }
  ...
  async startAuthFallback(req, res) {
    try {
      ...
      this.error(res, 'Failed to start fallback authentication');
    }
  }
  ...
  async verifyAuth(req, res) {
    try {
      ...
      this.error(res, 'Failed to verify authentication');
    }
  }
  ...
  async syncChannelPosts(req, res) {
    try {
      ...
      this.error(res, 'Failed to sync posts');
    }
  }
  ...
  async getCacheHealth(req, res) {
    try {
      ...
      this.error(res, 'Failed to get cache health');
    }
  }
  ...
  async refreshCache(req, res) {
    try {
      ...
      this.error(res, 'Failed to refresh cache');
    }
  }
  ...
  async getGalleryPhotos(req, res) {
    try {
      ...
      this.error(res, 'Failed to get gallery photos');
    }
  }
  ...
  async filterPhotosByAlbum(req, res) {
    try {
      ...
      if (!albumId) {
        return this.badRequest(res, 'Album ID is required');
      }
      ...
      this.error(res, 'Failed to filter photos by album');
    }
  }
  ...
  async filterPhotosByTags(req, res) {
    try {
      ...
      if (!tags) {
        return this.badRequest(res, 'Tags are required');
      }
  ...
  async initMTProtoAuth(req, res) {
    try {
      ...
      this.error(res, 'Failed to initialize MTProto authentication');
    }
  }
  ...
  async getMTProtoAuthStatus(req, res) {
    try {
      ...
      this.error(res, 'Failed to get MTProto auth status');
    }
  }
}

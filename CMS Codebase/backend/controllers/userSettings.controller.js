...
class UserSettingsController extends BaseController {
  ...
  try {
    ...
    if (!preferences) {
      ...
      return this.created(res, { message: 'User preferences created successfully', preferences: newPreferences });
    }

    this.success(res, { message: 'User preferences updated successfully', preferences });
  } catch (error) {

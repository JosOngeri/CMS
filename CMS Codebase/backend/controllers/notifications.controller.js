...
class NotificationsController extends BaseController {
  ...
  async getNotifications(req, res) {
    try {
      ...
      this.error(res, 'Failed to fetch notifications');
    }
  }
  ...
  async markAsRead(req, res) {
    try {
      ...
      this.error(res, 'Failed to mark notification as read');
    }
  }
  ...
  async markAllAsRead(req, res) {
    try {
      ...
      this.error(res, 'Failed to mark all notifications as read');
    }
  }
  ...
  async deleteNotification(req, res) {
    try {
      ...
      this.success(res, null, 'Notification deleted');
    } catch (error) {
      this.logger.error('deleteNotification', error);
      this.error(res, 'Failed to delete notification');
    }
  }
  ...
  async getUnreadCount(req, res) {
    try {
      ...
      this.error(res, 'Failed to get unread count');
    }
  }
  ...
  async getNotificationTypes(req, res) {
    try {
      ...
      this.success(res, types, 'Notification types retrieved successfully');
    } catch (error) {
      this.logger.error('getNotificationTypes', error);
      this.error(res, 'Failed to fetch notification types');
    }
  }
  ...
  async getPreferences(req, res) {
    try {
      ...
      this.success(res, preferences, 'Preferences retrieved successfully');
    } catch (error) {
      this.logger.error('getPreferences', error);
      this.error(res, 'Failed to fetch preferences');
    }
  }
  ...
  async updatePreferences(req, res) {
    try {
      ...
      this.error(res, 'Failed to update preferences');
    }
  }

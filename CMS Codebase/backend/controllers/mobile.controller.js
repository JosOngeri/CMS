...
class MobileController extends BaseController {
  ...
  async getMobileDashboard(req, res) {
    try {
      ...
      this.error(res, 'Failed to fetch mobile dashboard');
    }
  }
  ...
  async getMobileContent(req, res) {
    try {
      ...
      this.error(res, 'Failed to fetch mobile content');
    }
  }
  ...
  async getMobileAnnouncements(req, res) {
    try {
      ...
      this.error(res, 'Failed to fetch mobile announcements');
    }
  }
  ...
  async getMobileDepartments(req, res) {
    try {
      ...
      this.error(res, 'Failed to fetch mobile departments');
    }
  }
  ...
  async getMobileEvents(req, res) {
    try {
      ...
      this.error(res, 'Failed to fetch mobile events');
    }
  }
  ...
  async syncMobileData(req, res) {
    try {
      ...
      this.error(res, 'Failed to sync mobile data');
    }
  }
  ...
  async syncContacts(req, res) {
    try {
      ...
      this.error(res, 'Failed to sync contacts');
    }
  }
  ...
  async uploadContactChanges(req, res) {
    try {
      ...
      this.error(res, 'Failed to upload contact changes');
    }
  }
  ...
  async getDeltaContacts(req, res) {
    try {
      ...
      this.success(res, { data: deltaContacts });
    } catch (error) {
      this.logger.error('getDeltaContacts', error);
      this.error(res, 'Failed to get delta contacts');
    }
  }
  ...
  async syncTemplates(req, res) {
    try {
      ...
      this.error(res, 'Failed to sync templates');
    }
  }
  ...
  async uploadTemplateAnalytics(req, res) {
    try {
      ...
      this.error(res, 'Failed to upload template analytics');
    }
  }
  ...
  async getOfficialTemplates(req, res) {
    try {
      ...
      this.error(res, 'Failed to get official templates');
    }
  }
  ...
  async uploadSmsLogs(req, res) {
    try {
      ...
      this.error(res, 'Failed to upload SMS logs');
    }
  }
  ...
  async syncSmsLogs(req, res) {
    try {
      ...
      this.error(res, 'Failed to sync SMS logs');
    }
  }
  ...
  async getPendingSmsLogs(req, res) {
    try {
      ...
      this.success(res, { data: pendingLogs });
    } catch (error) {
      this.logger.error('getPendingSmsLogs', error);
      this.error(res, 'Failed to get pending SMS logs');
    }
  }
  ...
  async createMobileCampaign(req, res) {
    try {
      ...
      this.created(res, { data: campaign });
    } catch (error) {
      this.logger.error('createMobileCampaign', error);
      this.error(res, 'Failed to create mobile campaign');
    }
  }
  ...
  async getCampaignProgress(req, res) {
    try {
      ...
      this.success(res, { data: progress });
    } catch (error) {
      this.logger.error('getCampaignProgress', error);
      this.error(res, 'Failed to get campaign progress');
    }
  }
  ...
  async getMobileCampaigns(req, res) {
    try {
      ...
      this.error(res, 'Failed to get mobile campaigns');
    }
  }
  ...
  async getUnifiedAnalytics(req, res) {
    try {
      ...
      this.error(res, 'Failed to get unified analytics');
    }
  }
  ...
  async getSmsAnalytics(req, res) {
    try {
      ...
      this.error(res, 'Failed to get SMS analytics');
    }
  }
  ...
  async mobileLogin(req, res) {
    try {
      ...
      this.success(res, { data: authResult });
    } catch (error) {
  ...
  async refreshAuthToken(req, res) {
    try {
      ...
      this.success(res, { data: tokens });
    } catch (error) {
      this.logger.error('refreshAuthToken', error);
      this.unauthorized(res, 'Token refresh failed');
    }
  }
  ...
  async getSyncStatus(req, res) {
    try {
      ...
      this.success(res, { data: syncStatus });
    } catch (error) {
      this.logger.error('getSyncStatus', error);
      this.error(res, 'Failed to get sync status');
    }
  }
  ...
  async updateSyncStatus(req, res) {
    try {
      ...
      this.success(res, { message: 'Sync status updated' });
    } catch (error) {
      this.logger.error('updateSyncStatus', error);
      this.error(res, 'Failed to update sync status');
    }
  }
  ...
  async resetSync(req, res) {
    try {
      ...
      this.success(res, { message: 'Sync reset successfully' });
    } catch (error) {
      this.logger.error('resetSync', error);
      this.error(res, 'Failed to reset sync');
    }
  }
  ...
  async getMobileDevices(req, res) {
    try {
      ...
      this.success(res, { data: devices });
    } catch (error) {
      this.logger.error('getMobileDevices', error);
      this.error(res, 'Failed to get mobile devices');
    }
  }
  ...
  async registerMobileDevice(req, res) {
    try {
      ...
      this.created(res, { data: device });
    } catch (error) {
      this.logger.error('registerMobileDevice', error);
      this.error(res, 'Failed to register device');
    }
  }

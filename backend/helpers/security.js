...
// Use environment variable for bcrypt rounds, default to 12 for production, 8 for development
const SALT_ROUNDS = parseInt(process.env.BCRYPT_ROUNDS) || (process.env.NODE_ENV === 'production' ? 12 : 8);
...
const validatePasswordStrength = (password) => {
  ...
  const commonPatterns = [
    ...
    'church', 'sda', 'kiserian', 'kenya', 'nairobi'
  ];

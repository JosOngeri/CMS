...
router.get('/reports/trial-balance', treasuryController.getTrialBalance);
router.get('/reports/income-statement', treasuryController.getIncomeStatement);
router.get('/reports/balance-sheet', treasuryController.getBalanceSheet);
router.get('/reports/cash-flow', treasuryController.getCashFlowStatement);
router.get('/reports/fund-balance', treasuryController.getFundBalance);

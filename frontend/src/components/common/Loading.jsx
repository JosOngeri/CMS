    ...
    <>
      {Array.from({ length: rows }).map((_, index) => (
        <tr key={index} className="animate-pulse">
          ...
          <td className="px-6 py-4">
            <div className="h-4 rounded w-2/3" style={{ backgroundColor: colors.border }}></div>
          </td>
          <td className="px-6 py-4">
            <div className="h-4 rounded w-1/3" style={{ backgroundColor: colors.border }}></div>
          </td>
          <td className="px-6 py-4">
            <div className="h-4 rounded w-1/4" style={{ backgroundColor: colors.border }}></div>
          </td>
        </tr>
      ))}
    </>

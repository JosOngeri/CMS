/**
 * Playwright E2E Parity Test Suite for member1@newlife.com
...
const SCREENSHOT_DIR = path.join(__dirname, '../screenshots/mobile-parity-member1');
...
test.describe('Mobile Parity Assessment Suite - member1@newlife.com', () => {

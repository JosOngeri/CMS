...
- Name: comprehensive-website-test.spec.js >> KMainCMS Comprehensive Website Tests >> SMS Module >> SMS dashboard loads correctly
- Location: e2e\comprehensive-website-test.spec.js:383:5
...
```yaml
- generic [ref=e2]: "{\"success\":false,\"error\":\"API endpoint not found\"}"
```
